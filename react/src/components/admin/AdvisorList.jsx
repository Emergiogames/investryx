...
import { adminBusinessList } from "../../services/admin/apiMethods";
...
const AdvisorList = () => {
  ...
  const fetchPosts = () => {
    ...
    adminBusinessList()
      .then((response) => {
        // console.log("here is advisor");

        const postData = response.data;
        // console.log("advisor details :", postData);
  ...
  console.log("this is advisor adat :", postStates);
  ...
  const filteredPosts = postStates.filter((post) =>
    post.entity.toLowerCase().includes(searchTerm.toLowerCase())
  );
