...
import { adminFranchiseList } from "../../services/admin/apiMethods";
import { BASE_URL } from "../../constants/baseUrls";
import { useNavigate } from "react-router-dom";


const FranchiseLisit = () => {
  ...
  const fetchPosts = () => {
    ...
    adminFranchiseList()
      .then((response) => {
        console.log("here is admin franchise");

        const postData = response.data;
        console.log("franchise details :", postData);
  ...
  console.log("this is franchise adat :", postStates);
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {currentPosts.map((post, index) => (
                      <tr onClick={() => navigate(`/admin/admin_viewpost?post=${post.id}`, { state: { postData: post } })}
                        key={post.id}
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{post.entity}</td>
                        <td className="px-6 py-4 text-center">
                          {post.name}
                        </td>
                        <td className="px-6 py-4 text-center">
