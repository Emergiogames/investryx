...
import { adminUserList } from "../../services/admin/apiMethods";
...
const UserList = () => {
  ...
  const fetchUsers = () => {
    ...
    adminUserList()
      .then((response) => {
        console.log("adminside, userlist data :", response);

        const userData = response.data;
        setUserStates(userData);
      })
      .catch((error) => {
        console.log(error);
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    {/* <tr>
                      ...
                      <th scope="col" className="px-6 py-3">Shehin S</th>
                      <th scope="col" className="px-6 py-3 text-center text-green-500">Active</th>
                      <th scope="col" className="px-6 py-3 text-center">No</th>
                      <th scope="col" className="px-6 py-3 text-center text-green-500">Unblocked   </th>
                      <th scope="col" className="px-6 py-3 text-centerborder-t text-red-700">Block</th>
                    </tr> */}
                    {/* <tr>
                      <th scope="col" className="px-6 py-3">2</th>
                      <th scope="col" className="px-6 py-3">Amal N</th>
                      <th scope="col" className="px-6 py-3 text-center text-green-500">Active</th>
                      <th scope="col" className="px-6 py-3 text-center">No</th>
                      <th scope="col" className="px-6 py-3 text-center text-green-500">Unblocked   </th>
                      <th scope="col" className="px-6 py-3 text-centerborder-t text-red-700">Block</th>
                        ...
                        <td className="px-6 py-4 text-center">
                          {user.block ? (
                            <button
                              type="button"
                              onClick={() =>
                                confirmBlockUser(user._id, "unblock")
                              }
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                confirmBlockUser(user._id, "block")
                              }
