  ...
  return (
    <>
      <section className="flex">
        {/* calculator start */}
        <div className="w-1/2 bg-white p-0 sm:p-12">
          <div className="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
            ...
            <form id="form" noValidate>
              ...
              <button
                ...
                className="w-full px-6 py-3 mt-3 text-lg text-white rounded-lg shadow bg-violet-500 hover:bg-violet-600 focus:outline-none"
              >
                Calculate
              </button>
            </form>
        ...
        <div className="w-1/2 flex flex-col justify-center p-14">
          {/* <div className="text-4xl font-medium">
            Business Valuation Calculator for Accurate Estimations
          </div>
          <div className="text-l my-4">
            Enhance your business planning with our accurate valuation tools.
          </div> */}
