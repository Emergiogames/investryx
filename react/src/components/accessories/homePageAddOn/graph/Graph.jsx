...
function Graph({ props }) {
  ...
  // console.log("Graph data lastz: ", graphData);
  ...
  return (
    <div className="max-w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:px-44">
      <div className='py-20'>
      <h1 className='font-medium text-3xl py-6 '>Profit Profile</h1>
      <h1 className='max-w-md'>Percentage change based on the businessData. We'll use the total value for the "Total Business" display and calculate the percentage change for the business data.</h1>
      </div>
