...
const RecommendedListing = ({ props }) => {
  ...
  console.log("recommended data@component :", posts);
  ...
  return (
    <div className="w-full relative">
      <div className="multiple-slide-carousel swiper-container relative">
        <div className="text-4xl font-medium mb-5 ml-24 mt-28">
          Recommendation{" "}
        </div>
        <Swiper
          ref={swiperRef}
            ...
            <SwiperSlide key={post.id}>
              ...
              >
                ...
                <div className="relative mb-4 rounded-2xl">
                  <img
                    className="h-80  rounded-2xl w-full object-cover transition-transform duration-300 transform group-hover:scale-105"
