              ...
              <div className="space-y-4">
                ...
                <div className="xl:flex justify-end">
                  <p className="leading-6 max-w-sm text-gray-100">
                    With a user-friendly interface, businesses can create
                    detailed profiles to highlight their unique value
                    propositions and funding needs.
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <ul role="list" className="mt-6 space-y-4">
                      <li className="flex">
                        ...
                        >
                          Invystryx, Lorle Roady, Lorel Ipsum
                        </a>
                      </li>
