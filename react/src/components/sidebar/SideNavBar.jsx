...
function SideNavBar() {
  ...
  return (
    <div className="w-full max-w-xs sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-[15rem] block justify-end">
      <div className="sm:w-0 md:w-4/12 max-w-72 block justify-end sm:p-0 md:p-2">
        ...
        <aside
          id="logo-sidebar"
          className={`pl-2 ml-0 border hover:shadow-md fixed left-0 z-40 w-64 h-screen transition-transform ${
            ...
            <ul className="space-y-0 font-medium">
              <li>
                ...
                >
                  ...
                  <span className="ms-3 text-lg">All Transactions</span>
                </Link>
              </li>
              <li>
                <div
                  onClick={openSearchbar}
                  className="flex items-center cursor-pointer p-2 pb-3 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100  00 dark:hover:bg-gray-700 dark:text-white group"
                >
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                    aria-hidden="true"
                  ...
                  <span className="ms-3 text-lg">Business For Sale</span>
                </div>
                {isSearchbarOpen && (
                  <Searchbar closeSearchmodal={closeSearchbar} />
                )}
              </li>
              <li>
                <Link
              ...
              {isAddPostOpen && { handleClose } && (
                <AddPost closeAddPost={closeAddPostModal} />
              )}
            </ul>
            <ul className="pt-4 mt-4 space-y-0 font-medium border-t border-gray-200 dark:border-gray-700">
              <li>
                ...
                >
                  ...
                  <span className="ms-3 text-lg">Locations</span>
                </Link>
                <div className="font-light pl-10 cursor-pointer">
                  <ul>Africa</ul>
                  <ul>Asia</ul>
                  <ul>Europe</ul>
                  <ul>North America</ul>
              ...
              <li>
                ...
                >
                  ...
                  <span className="ms-3 text-lg">Industries</span>
                </div>
                <div className="font-light pl-10 cursor-pointer">
                  <ul>Building</ul>
                  <ul>Business Services</ul>
                  <ul>Education</ul>
                  <ul>Energy</ul>
                  <ul>Finance</ul>
                  <ul>Food & Bev</ul>
