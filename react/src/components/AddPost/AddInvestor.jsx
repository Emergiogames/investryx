...
//           <div className="dark:bg-black bg-white my-24 w-1/2 rounded-md">
//           {/* close buttn  */}
//             <button
//               onClick={handleClose}
...
//             <h2 className="pl-16 text-blue-700">Add Investment Plan</h2>
//             <div className="max-w-md mx-64">
//               {loading && (
...
//                 <input
//                   value={formik.values.ebitda}
//                   onChange={formik.ebitda}
//                   onBlur={formik.ebitda}
//                   autoComplete="off"
//                   name="address2"
//                   id="address2"
//                   className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
...
//                     </div>
//                   )}
//                   {formik.values.image1.length > 0 && !formik.errors.image1 && (
//                     <div className="mt-4">
//                       <p className="font-medium">Selected Images:</p>
//                       <div className="flex flex-wrap gap-4 mt-2 mb-2" key={1}>
//                         {selectedFiles1.map((file, index) => (
//                           <div
//                             key={index}
//                             className="w-36 h-32 border border-gray-300 rounded-md overflow-hidden"
...
//                     </div>
//                   )}
//                   {formik.values.doc1.length > 0 && !formik.errors.doc1 && (
//                     <div className="mt-4">
//                       <p className="font-medium">Selected Images:</p>
//                       <div className="flex flex-wrap gap-4 mt-2 mb-2" key={2}>
//                         {selectedFiles2.map((file, index) => (
//                           <div
//                             key={index}
//                             className="w-36 h-32 border border-gray-300 rounded-md overflow-hidden"
...
//                   {/* <div className="relative z-0 w-full mb-5 group">
//                 <input
//                   value={formik.values.documentOne}
//                   onChange={formik.handleChange}
//                   onBlur={formik.handleBlur}
//                   autoComplete="off"
//                   name="documentOne"
...
//                     </div>
//                   )}
//                   {formik.values.proof1.length > 0 && !formik.errors.proof1 && (
//                     <div className="mt-4">
//                       <p className="font-medium">Selected Images:</p>
//                       <div className="flex flex-wrap gap-4 mt-2 mb-2" key={3}>
//                         {selectedFiles3.map((file, index) => (
//                           <div
//                             key={index}
//                             className="w-36 h-32 border border-gray-300 rounded-md overflow-hidden"
