...
const PreferencesForm = () => {
  ...
  useEffect(() => {
    ...
    // Get profile-specific questions
    const profileQuestions = questionData.profile_specific[userProfile.toLowerCase()] || [];
    // Get remaining common questions (skip the first one as it's already shown)
    ...
    // Log for debugging
    console.log('Updated question list:', orderedQuestions);
  ...
  const isQuestionAnswered = () => {
    ...
    const isMultiSelect = questionKey === 'question1' || questionKey === 'question16';
