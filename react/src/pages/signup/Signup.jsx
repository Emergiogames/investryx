...
import signupImg from "/images/investment_img/emergio_piggy_money.jpg";
import {
  validationSchema,
  initialValues,
...
function Signup() {
  ...
  const submit = (values) => {
    ...
    postRegOtp(phoneData) //mail and phone - check both and otp
      .then((response) => {
  ...
  //   .then((data) => {
  //     console.log('suerdata for firebase', data);

  //     const userData = {
  //       name: data.user.displayName,
  //       email: data.user.email,
  //       images: data.user.photoURL
  //     }
  //     // console.log("userDat at fronend @signup :", userData);
